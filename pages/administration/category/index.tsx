...
import {ADMINISTRATION_CATEGORY_PATH} from "../../../resources/paths";
import {
	createConfiguration,
	editConfiguration,
	validationSchema
} from "../../../configurations/forms/CategoryFormConfiguration";
...
const Category: NextPage = () => {
	...
	const subject = {path: ADMINISTRATION_CATEGORY_PATH, name: ADMINISTRATION_CATEGORY};
