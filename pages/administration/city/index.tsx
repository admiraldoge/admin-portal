...
import {ADMINISTRATION_CITY, ADMINISTRATION_UNIT_OF_MEASURE,} from "../../../constants/subjects";
...
import {ADMINISTRATION_CITY_PATH, ADMINISTRATION_UNIT_OF_MEASURE_PATH,} from "../../../resources/paths";
import {
	createConfiguration,
	editConfiguration,
	validationSchema
} from "../../../configurations/forms/CityFormConfiguration";

const City: NextPage = () => {
	const dispatch = useAppDispatch();
	const list = useAppSelector((state: RootState) => state.list);
	const subject = {path: ADMINISTRATION_CITY_PATH, name: ADMINISTRATION_CITY};
